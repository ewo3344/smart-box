...
""",
    ...
    def test_build_script_uses_clean_exact_staging_manifest(self) -> None:
        ...
        tarball = project / "dist" / "smart-box-0.1.0-linux-x86_64.tar.gz"
        first_archive_hash = hashlib.sha256(tarball.read_bytes()).hexdigest()
        ...
        self.assertEqual(
            hashlib.sha256(tarball.read_bytes()).hexdigest(), first_archive_hash
        )
