...
- **Android 0.1.1 vivo 覆盖安装 (2026-08-30)**: BLOCKED。`~/.android/debug.keystore` SHA-256 `2e8d0212…` 与设备已装 0.1.0 签名 `8de57370…` 不一致。未卸载、未安装。设备仍为 `0.1.0-core.1.14.0-beta.14` / `versionCode=10000`。
